...
if(is.null(PCMFitDemoObjects$fitBM)) {
...
if(is.null(PCMFitDemoObjects$fitOU)) {
...
if(is.null(PCMFitDemoObjects$fitMGPMTrueTypeMapping)) {
...
if(is.null(PCMFitDemoObjects$fitMGPMTrueTypeMappingCheat)) {
  fitMGPMTrueTypeMappingCheat <- PCMFit(
    X, treeWithTrueShifts, modelTrue, metaI = PCMBaseCpp::PCMInfoCpp)
