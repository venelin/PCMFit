...
-   [PCMFit: Statistical inference of phylogenetic comparative models](#pcmfit-statistical-inference-of-phylogenetic-comparative-models)
-   [Installation](#installation)
    -   [Prerequisites](#prerequisites)
    -   [Installing PCMFit](#installing-pcmfit)
    -   [Parallel execution](#parallel-execution)
-   [Resources](#resources)
-   [Related tools](#related-tools)
-   [Citing PCMFit](#citing-pcmfit)
-   [Used software packages](#used-software-packages)
